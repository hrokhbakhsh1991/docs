...
| Subphases      | `subphases/1.1`–`1.6`              | exit*criteria*\*        |
...
| ID            | Item                                        | Status                                                                                                             |
| ------------- | ------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ |
| GAP-MAP-14-1  | Architect sign-off                          | **Closed** — 2026-06-06 @ `1697b77` ([checklist](../../reports/phase-1-architect-signoff-checklist-2026-06-03.md)) |
