...
exit_criteria_1_6:
  ...
  - id: EC-16-6
    check: g13_facade_test_ratio ≥ PHASE_1_FACADE_TEST_RATIO_MIN (0.6) on closure specs excl test/unit/**
    verify: scripts/guards/gate-thresholds.mjs + scripts/guards/lib/facade-test-ratio.mjs
```
