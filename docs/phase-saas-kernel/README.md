...
| [appendices/SK3_ENTITLEMENT_FLAGS.md](./appendices/SK3_ENTITLEMENT_FLAGS.md) | SK3 Entitlement + flags (**design closed**; FLAGS field **DONE**) |
| [appendices/SK3_FLAGS_IMPLEMENTATION.md](./appendices/SK3_FLAGS_IMPLEMENTATION.md) | SK3-FLAGS `inAppRegistrationApprovedNotify` evidence |
