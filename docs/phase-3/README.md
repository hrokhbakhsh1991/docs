...
Phase 3 delivers `WorkspacePlugin`, CASL, and `CanonicalTourService` consumed by Phases 4–5. Hub: [`../appendices/PLATFORM-CONTINUITY-0-5.md`](../appendices/PLATFORM-CONTINUITY-0-5.md) · [`../phase-5/appendices/phase-0-3-bridge.md`](../phase-5/appendices/phase-0-3-bridge.md) · handoff: [`../phase-4/appendices/phase-handoff-3-4-5.md`](../phase-4/appendices/phase-handoff-3-4-5.md)
