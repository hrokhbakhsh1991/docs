...
> **Honesty:** `packages/workspaces/denali` is a **guard probe**, not the product workspace until 6.1 VERIFIED.

## Subphase ledger

| Subphase | Status    | REQ (primary)      | Evidence (target)                 | Blocker                           |
| -------- | --------- | ------------------ | --------------------------------- | --------------------------------- |
| **6.0**  | PARTIAL   | REQ-P6-001–003     | `phase-6-entry-verified.yaml`     | phase-5:gate PENDING in yaml      |
| **6.1**  | SPEC_ONLY | REQ-P6-004–005     | `getDenaliWorkspacePlugin`        | probe not replaced                |
| **6.2**  | SPEC_ONLY | REQ-P6-006–009     | `registry-parity.spec.ts`         | no port yet                       |
| **6.3**  | SPEC_ONLY | REQ-P6-010         | composites + `theme/tokens.css`   | —                                 |
| **6.4**  | SPEC_ONLY | REQ-P6-011–012,028 | `finance-outbox-consumer.spec.ts` | BLOCKER-P6-OUTBOX-5.4 if 5.4 open |
| **6.5**  | SPEC_ONLY | REQ-P6-013–014     | `denali-workspace-plugin.spec.ts` | NOT_BOUND today                   |
| **6.6**  | SPEC_ONLY | REQ-P6-015,023     | golden fixtures + smoke           | —                                 |
| **6.7**  | SPEC_ONLY | REQ-P6-016         | `minio-photo.spec.ts`             | MinIO env optional                |
| **6.8**  | SPEC_ONLY | REQ-P6-017         | migrate integration               | hook NOT_IMPLEMENTED              |
| **6.9**  | PARTIAL   | REQ-P6-018–022     | `phase-6:guard` scaffold          | gate partial                      |
