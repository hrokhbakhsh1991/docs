...
| `bookings-pagination-stress.spec.ts` (Postgres stress) | Exact-limit + tie-break seeds |
| `bookings-perf.spec.ts` (Postgres projection) | Bulk SEED_ROW_COUNT on one tour |
