...
| سطح | URL |
| --- | --- |
| پنل ادمین | http://89.45.89.206:23000/auth/login |
| مارکتینگ | http://89.45.89.206:23002/tours |
| پورتال مهمان | http://89.45.89.206:23003 |

**ورود اپراتور (OTP staging):** `+15550001001` / `1234`
