...
| `packages/workspaces/urban/test/urban-owner-ability.spec.ts`     | **8.1**                            | Owner/member contract specs                                                                                                           |
| `apps/web/app/(app)/settings/workspace-owner/workspace-owner-settings-access.ts` | **8.1** | Owner guard — thin wrapper over [`CANLOAD-URBAN-SETTINGS.contract.ts`](../appendices/CANLOAD-URBAN-SETTINGS.contract.ts) (DEC-P8-004 · Wave H.i.b path `/settings/workspace-owner` · Wave H.m filename) |
