...
> **Agents:** Read this before any Phase 8 implementation claim. **8.0** is **VERIFIED_ENTRY** · **8.1** is **VERIFIED_BEHAVIORAL** (6 prove_with specs green + `apps/api/src/urban/**` on trunk). **doc_ready** advances to **8.2**; subphases **8.2–8.5** remain **SPEC_ONLY** or **ABSENT** until their behavioral proof lands. Do not claim Product Parity DoD from this doc pack alone.
