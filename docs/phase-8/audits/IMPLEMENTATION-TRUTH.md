...
> **Agents:** Read this before any Phase 8 implementation claim. **8.0** is **VERIFIED_ENTRY** · **8.1** is **READY_FOR_IMPLEMENTATION** (doc + guard attestation — **not** `VERIFIED_BEHAVIORAL`). Subphases **8.2–8.5** remain **SPEC_ONLY** or **ABSENT** until behavioral proof lands. Do not claim Product Parity DoD from this doc pack alone.
...
| --------------------------------------------------------- | ---------------- | ----------------------------------------------------------------- | ------------- |
| `packages/workspace-sdk/test/urban-owner-ability.spec.ts` | **SCAFFOLD_WIP** | `TEMP/phase8-wip-specs/workspace-sdk/urban-owner-ability.spec.ts` | T-8.1         |
| `apps/api/test/urban-owner-ability.spec.ts`               | **SCAFFOLD_WIP** | `TEMP/phase8-wip-specs/urban-owner-ability.spec.ts`               | T-8.1         |
| `apps/api/test/urban-settings-patch.spec.ts`              | **SCAFFOLD_WIP** | `TEMP/phase8-wip-specs/urban-settings-patch.spec.ts`              | T-8.1         |
| `apps/api/test/urban-redis-fallback.spec.ts`              | **SCAFFOLD_WIP** | `TEMP/phase8-wip-specs/urban-redis-fallback.spec.ts`              | T-8.1         |
| `apps/api/test/urban-tours-bypass-gate.spec.ts`           | **SCAFFOLD_WIP** | `TEMP/phase8-wip-specs/urban-tours-bypass-gate.spec.ts`           | T-8.1         |
| `apps/web/test/urban-owner-access.spec.ts`                | **SCAFFOLD_WIP** | `TEMP/phase9-wip-specs/web/urban-owner-access.spec.ts`            | T-8.1         |

**Guard impact:** Sprint A is **doc-only** — `p8_spec_path_registry` passes after **T-8.1 promote PR** (pair with `apps/api/src/urban/**` stubs or 8.1 impl).
