...
| 15  | `p8_api_surface_alignment`        | yes      | `verifyApiSurfaceAlignment` (`phase-8-hardening-artifacts.mjs`)     | **DEC-P8-004** · SDK `authz.canPerformUrbanOwnerMutation` · `isWorkspaceOwner` from tenant-auth-grants · router urban-settings-access                                                                         |
...
| 24  | `p8_urban_not_denali_rail`        | yes      | `runP8UrbanNotDenaliRail` (`phase-8-guard.mjs`)                     | Urban ↔ denali isolation                                                                                                                                                                                      |
