...
| Rule        | Enforcement                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ----------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| INV-WIZ-001 | Unknown `canonicalPath` on PUT → **400** `SETTINGS_WIZARD_UNKNOWN_FIELD` (W4). Starter **does not** alias Denali `title` (DG-2 catalog neutrality — empty `wizardTemplate.pathAliases`; API-9.6-CFG-06). Denali `title` is valid only on denali workspace catalog. |
...
| Artifact                | Path                                        | Behavior                                                                                           |
| ----------------------- | ------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| Profile API             | `apps/api/src/identity/me.service.ts`       | `GET/PATCH /identity/me` — self-scoped; `displayName` · optional `gender` in `membership_metadata` |
...
| Profile UI              | `apps/web/app/(app)/settings/me/`           | Read-only phone/role + editable display name · optional gender · avatar upload (MinIO · self)      |
