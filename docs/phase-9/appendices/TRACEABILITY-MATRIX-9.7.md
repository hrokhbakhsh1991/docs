...
| **REQ-P9-072** | [`FINANCE-OPS-UX.md`](FINANCE-OPS-UX.md) §5.6 · reconciliation                                                       | `(app)/settings/reconciliation-triage`                                        | **P9-7-A03**                | N/A           | `apps/web/test/reconciliation-triage.spec.ts` (DEFERRED_R1) |
