...
| Partial/full manual payment               | `apps/api/src/workspace-finance/finance.service.spec.ts` (`PR20-B`), `apps/api/test/finance-ops.spec.ts` (`API-9.7-03`) | service; HTTP requires PostgreSQL |
