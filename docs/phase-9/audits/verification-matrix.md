...
| **REQ-P9-072** | 9.7      | Reconciliation triage · **DEFERRED_R1**                                         | `apps/web/test/reconciliation-triage.spec.ts` (scaffold only)                                                                   | `pnpm --filter @apps/web exec node --import tsx --test test/reconciliation-triage.spec.ts`                                                                                            |
