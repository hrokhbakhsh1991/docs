...
- **Evidence packet:** [`docs/dev/decisions/DEC-CW-03-evidence.md`](decisions/DEC-CW-03-evidence.md) (PROPOSAL — Option A dual strategies; mixture classification; 2026-08-23).
