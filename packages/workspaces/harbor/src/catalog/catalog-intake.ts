...
const REGISTRATION_API_PATH = "/harbor/registrations";
...
export const harborCatalogIntakeSurface: WorkspaceCatalogIntakeSurface = Object.freeze({
  registrationApiPath: REGISTRATION_API_PATH,
  schema: () => INTAKE_SCHEMA,
  resolveEffectiveSchema,
  resolveSubmitValues,
  buildUpstreamRequest: (payload, options) => {
    const key = options?.idempotencyKey?.trim() || "portal-harbor-registration";
