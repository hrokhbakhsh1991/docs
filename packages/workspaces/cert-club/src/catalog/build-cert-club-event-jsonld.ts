...
/** Minimal Event JSON-LD for cert-club catalog card stubs (guestSeo.builderExport). */
export function buildCertClubEventJsonLd(card: PublicCatalogCard): EventJsonLd {
