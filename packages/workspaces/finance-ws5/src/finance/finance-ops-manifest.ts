/**
 * Finance-ws5 ops UI capability — workspace-owned panels/currencies.
 * Generic web resolves via generated bindings only.
 */
...
/** Merge tenant theme `financeOps` overrides onto the WS5 default manifest. */
