...
export function CertEventsIntakeStep({ state, dispatch }: RegistrationFlowStepProps): JSX.Element {
...
export function CertEventsDoneStep({ context }: RegistrationFlowStepProps): JSX.Element {
  return (
    <div data-public-registration-success data-cert-events-registration-success={true}>
