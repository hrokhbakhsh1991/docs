...
/** Minimal Event JSON-LD for profile-cert catalog card stubs (guestSeo.builderExport). */
export function buildProfileCertEventJsonLd(card: PublicCatalogCard): EventJsonLd {
