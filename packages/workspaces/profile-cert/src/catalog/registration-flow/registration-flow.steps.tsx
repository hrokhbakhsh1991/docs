...
export function ProfileCertIntakeStep({ state, dispatch }: RegistrationFlowStepProps): JSX.Element {
...
export function ProfileCertDoneStep({ context }: RegistrationFlowStepProps): JSX.Element {
  return (
    <div data-public-registration-success data-profile-cert-registration-success={true}>
