...
const REGISTRATION_API_PATH = "/profile-cert/registrations";
...
export const profileCertCatalogIntakeSurface: WorkspaceCatalogIntakeSurface = Object.freeze({
  registrationApiPath: REGISTRATION_API_PATH,
  schema: () => INTAKE_SCHEMA,
  resolveEffectiveSchema,
  resolveSubmitValues,
  buildUpstreamRequest: (payload, options) => {
    const key = options?.idempotencyKey?.trim() || "portal-profile-cert-registration";
