...
export const DENALI_FIELD_DEFINITIONS: readonly DenaliFieldDefinition[] = [
  ...
  },
  {
    ...
    settingsSurface: "deprecated",
    notes:
      "Legacy review summary only; no modern wizard input — excluded from Settings overlay (Layer C).",
  },
  {
  ...
  },
  {
    ...
    wire: [
      { kind: "tripDetails.logistics", field: "gatheringPoints" },
      { kind: "derived", description: "Primary station feeds logistics.meetingPoint when set." },
    ],
  },
  {
    ...
    wire: [
      { kind: "tripDetails.overview", field: "startPoint" },
      { kind: "derived", description: "May set logistics.startPointVillage." },
    ],
  },
  {
  ...
  },
  {
    ...
    wire: [
      { kind: "tripDetails.overview", field: "endPoint" },
  ...
  {
    canonicalPath: "tripDetails.overview.customServiceLabels",
    stepId: "denali_logistics",
    ...
    contextualVisibility: { kind: "capability", flag: "canDefineCustomServices" },
    structuralInvariant: { kind: "clearWhenNotVisible" },
    notes: "Workspace profile capability; rendered on logistics step when canDefineCustomServices.",
  },
  {
    canonicalPath: "tripDetails.overview.nonAttendanceDetails",
