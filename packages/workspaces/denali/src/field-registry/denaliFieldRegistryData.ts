...
export const DENALI_FIELD_DEFINITIONS: readonly DenaliFieldDefinition[] = [
  ...
  },
  {
    ...
    tags: ["destination", "deliverable"] as const,
    ruleDefaults: { required: true, hidden: false },
  },
  {
  ...
  },
  {
    ...
    tags: ["optional_basic", "deliverable"] as const,
    ruleDefaults: { required: false, hidden: false },
    contextualVisibility: { kind: "singleDayTourOnly" },
    structuralInvariant: { kind: "clearWhenNotVisible" },
  },
  {
  ...
  },
  {
    ...
    zodKind: "locationData",
    tags: ["outdoor_logistics_location", "event_logistics_hidden", "deliverable"] as const,
    ruleDefaults: { required: false, hidden: false },
    cellOverrides: {
      "event:single_day": { required: false, hidden: true },
    },
  ...
  },
  {
    ...
    stepId: "denali_logistics",
    rhfPath: "tripDetails.logistics.includedServices",
    zodPath: "tripDetails.logistics.includedServices",
    zodKind: "stringArrayDefault",
    tags: ["core"] as const,
    ruleDefaults: { required: false, hidden: false },
    wire: [{ kind: "tripDetails.logistics", field: "includedServices" }],
    notes: "Services provided by the tour operator (legacy logistics.includedServices).",
  },
  {
    canonicalPath: "tripDetails.logistics.excludedServices",
    stepId: "denali_logistics",
    rhfPath: "tripDetails.logistics.excludedServices",
    zodPath: "tripDetails.logistics.excludedServices",
    zodKind: "stringArrayDefault",
    tags: ["core"] as const,
    ruleDefaults: { required: false, hidden: false },
    wire: [{ kind: "tripDetails.logistics", field: "excludedServices" }],
    notes: "Services participants bring or arrange themselves (legacy logistics.excludedServices).",
  },
  {
  ...
  },
  {
    ...
    stepId: "denali_pricing",
    rhfPath: "pricingPayment.prepaymentEnabled",
    zodPath: "pricingPayment.prepaymentEnabled",
    zodKind: "booleanOptional",
    tags: ["core"] as const,
    ruleDefaults: { required: false, hidden: false },
  ...
  },
  {
    ...
    stepId: "denali_pricing",
    rhfPath: "pricingPayment.prepaymentPercent",
    zodPath: "pricingPayment.prepaymentPercent",
    zodKind: "optionalPositiveInt",
    tags: ["core"] as const,
    ruleDefaults: { required: false, hidden: false },
    contextualVisibility: { kind: "whenTruthy", watchCanonical: "pricing.prepaymentEnabled" },
    contextualRequired: { kind: "whenTruthy", watchCanonical: "pricing.prepaymentEnabled" },
    structuralInvariant: { kind: "clearWhenNotVisible" },
  },
  {
  ...
  {
    canonicalPath: "participants.fatherNameRequired",
    stepId: "denali_pricing",
    rhfPath: "participantRequirements.fatherNameRequired",
    zodPath: "participantRequirements.fatherNameRequired",
    zodKind: "booleanOptional",
    tags: ["core"] as const,
    ruleDefaults: { required: false, hidden: false },
  },
  {
    canonicalPath: "participants.birthDateRequired",
    stepId: "denali_pricing",
    rhfPath: "participantRequirements.birthDateRequired",
    zodPath: "participantRequirements.birthDateRequired",
    zodKind: "booleanOptional",
    tags: ["core"] as const,
    ruleDefaults: { required: false, hidden: false },
  },
  ...
  },
  {
    ...
    zodKind: "optionalInt",
    tags: ["mountain_participants", "non_mountain_participants_hidden", "deliverable"] as const,
    ruleDefaults: { required: true, hidden: false },
