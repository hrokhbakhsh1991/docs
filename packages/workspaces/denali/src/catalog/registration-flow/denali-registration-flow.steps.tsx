  ...
  return (
    <form onSubmit={handleSubmit} data-public-registration-intake data-tour-id={context.tourId}>
      ...
      {otherGuests.length === 0 ? (
        <section data-registration-other-guest-list aria-label={t("intake.otherGuestsTitle")}>
        ...
        <section data-registration-other-guest-list aria-label={t("intake.otherGuestsTitle")}>
                          ...
                          setOtherGuests((prev) =>
                            prev.map((g, idx) =>
                              idx === guestIdx
                                ? {
                                    ...g,
                                    transportState: { ...g.transportState, hasPersonalCar: true, paysDong: null },
                                  }
                                : g
                            )
                          )
                                ...
                                setOtherGuests((prev) =>
                                  prev.map((g, idx) =>
                                    idx === guestIdx
                                      ? {
                                          ...g,
                                          transportState: { ...g.transportState, personalCarOccupants: count },
                                        }
                                      : g
                                  )
                                )
          ...
          {otherGuests.length >= DENALI_MAX_OTHER_GUESTS ? (
            ...
            <button
              ...
              onClick={() =>
                setOtherGuests((prev) =>
                  prev.length >= DENALI_MAX_OTHER_GUESTS ? prev : [...prev, createEmptyOtherDraft()]
                )
              }
            >
              {t("intake.addGuest")}
