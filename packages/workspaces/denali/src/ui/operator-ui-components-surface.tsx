...
import { DenaliLocationPickerMap } from "./components/map/denali-location-picker-map";
...
export type DenaliOperatorUiComponentsSurface = {
  ...
  readonly LocationPickerMapInner: typeof DenaliLocationPickerMap;
...
export const denaliOperatorUiComponentsSurface: DenaliOperatorUiComponentsSurface = Object.freeze({
  ...
  LocationPickerMapInner: DenaliLocationPickerMap,
  ensureLeafletDefaultIcon: () => {
    if (typeof window !== "undefined") {
      void import("./components/map/leaflet-default-icon").then((mod) =>
        mod.ensureLeafletDefaultIcon()
      );
    }
  },
