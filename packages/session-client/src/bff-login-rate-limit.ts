/**
 * Shared BFF login rate limit — defense-in-depth before API OTP throttles.
 * Apps keep their own module instances, but the request key/window semantics stay identical.
 */
...
export type BffLoginRateLimitRequest = {
  readonly headers: {
...
export function readBffLoginRateLimitKey(req: BffLoginRateLimitRequest, phone?: string): string {
