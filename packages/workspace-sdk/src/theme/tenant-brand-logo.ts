...
export type TenantBrandLogoContentType = (typeof TENANT_BRAND_LOGO_ALLOWED_CONTENT_TYPES)[number];

export function isTenantBrandLogoContentType(value: string): value is TenantBrandLogoContentType {
