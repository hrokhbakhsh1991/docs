...
} from "../src/operator/bookings/registration-intake.contract";

describe("registration-intake.contract", () => {
  it("SDK-INT-01 parses transport kind and occupants", () => {
  ...
  it("SDK-INT-02 formats transport label with occupants", () => {
