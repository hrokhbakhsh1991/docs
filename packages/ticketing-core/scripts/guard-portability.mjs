#!/usr/bin/env node
/**
 * ticketing-core portability — Phase 2B packaging invariants.
 */
...
if (runtimeDeps.length > 0) {
  fail(`ticketing-core must have zero runtime dependencies (found: ${runtimeDeps.join(", ")})`);
}
...
if (errors.length > 0) {
  console.error("guard-ticketing-core-portability: FAIL");
...
console.log("guard-ticketing-core-portability: PASS");
