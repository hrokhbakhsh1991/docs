...
- **Decision:** **RESOLVED for CW-S1.** Use one-way dependency `workspace-sdk → tour-core → booking-http-contracts`. `tour-core` must **not** import `workspace-sdk`.
...
- **Blocks transitively:** CW1-02..06; CW3-01..09; CW4-01..08; CW5-02..11; CW6-01..04, CW6-05A, CW6-05B, CW6-06..07; CW7-01..15; CW8-01..07; CW9-01..10. This record is resolved in-plan but requires Architect approval as CW-S1 precondition.
- **Does NOT block exactly:** CW0-01..10; CW2-01..07. All later tour-core-dependent tasks are transitively blocked.
- **Latest safe point:** CW0-10. Must be resolved/approved before CW1-01 creates the package.
...
- **While unresolved:** **STOP CW1-01 and all tour-core tasks; CONTINUE CW-0/CW-2 work**.
