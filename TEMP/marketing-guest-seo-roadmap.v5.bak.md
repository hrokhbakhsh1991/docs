# Marketing Guest SEO — Execution Roadmap v5
...
| T-004 | metadata tests | `test/build-marketing-metadata.spec.ts` | 02 | T-003 | MKT-17,18 |
...
| T-011 | SDK contract field | `public-catalog.contract.ts` | 10 | T-010 | SDK build |
...
| T-022 | codegen | `generate-workspace-guest-seo.mjs` | 04 | T-021 | generate |
| T-023 | resolveGuestSeoForPlugin | `workspace-sdk/src/seo/` | 04 | T-022 | spec |
| T-024 | guard-guest-seo step 15 | `scripts/guards/guard-guest-seo.mjs` | 06 | T-023 | 15/15 |
...
| T-042 | alternates languages + x-default | `build-marketing-metadata.ts` | 03,21 | T-041 | MKT-21 |
...
| T-053 | OG width/height | `build-marketing-metadata.ts` | 25 | T-003 | MKT-18 |
...
| Task | کار | GAP | Verify |
|------|-----|-----|--------|
| T-060 | pagination noindex metadata | 16 | MKT-19 |
| T-061 | sitemap exclude query URLs | 16 | unit |
| T-062 | ItemList JSON-LD list page | 17 | MKT-20 |
...
| T-082 | mother/maintenance noindex | 28 | MKT-22,23 |
| T-083 | not-found metadata | 27 | MKT-24 |
| T-084 | club home canonical | 28 | MKT-25 |
| T-085 | @graph JSON-LD bundler | 34 | unit |
| T-086 | Urban Event v2 | 35 | unit |
| T-087 | Offer availability | 36 | validator |
...
| Task | کار | GAP | Verify |
|------|-----|-----|--------|
| T-090 | og:locale alternates | 33 | MKT-26 |
