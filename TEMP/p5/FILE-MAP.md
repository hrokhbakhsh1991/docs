...
| P5-A-N-003 | IMPLEMENT | ✅ | `derive-metadata-cutover-stage.ts`, `platform-tenant-workspace-definition.dto.ts`, `platform-tenant-metadata-cutover.spec.ts` | CO-01..04 stage derivation |
| P5-A-N-004 | IMPLEMENT | ✅ | `apps/web/src/platform/club-detail/tab-workspace-definition.tsx`, `apps/web/test/platform-club-workspace-cutover-tab.spec.ts` | UI-01 cutover badge |
| P5-A-N-005 | DOC | ✅ | `docs/phase-18/platform-metadata-cutover-pilot.mdoc` | DOC-02 staging env checklist |
| P5-A-N-006 | IMPLEMENT | ✅ | `metrics.ts`, `is-workspace-metadata-validation-path-active.ts`, `workspace-metadata-cutover-metrics.spec.ts` | MET-01..02 validation counter |
...
| P5-A-N-009 | TEST | ✅ | `platform-tenant-workspace-definition-audit.spec.ts` | AUD-01..03 existing audit actions |
...
| P5-A-N-012 | DOC | ✅ | `TEMP/p5/FILE-MAP.md`, `TEMP/p5/DOC-SYNC-INDEX.md` | EPIC-A rows synced (nano_done 12) |
| P5-A-N-013 | IMPLEMENT | ✅ | `scripts/p5-enterprise-evolution-gate.sh`, `package.json`, `platform-club-workspace-cutover-tab.spec.ts` | GATE-04..05 p5:gate + UI specs |
| P5-A-N-014 | TEST | ✅ | `TEMP/p5-exit-checklist.md`, `TEMP/wizard-denali-enterprise-assessment.md` | EX-A-01..02 EPIC-A exit |
...
| P5-B-N-006 | TEST | ✅ | `apps/api/test/workspace-metadata-denali-parity-publish.spec.ts` | RP-01..04 golden on metadata path |
...
| P5-B-N-012 | IMPLEMENT | ✅ | `apps/api/src/audit/audit-logger.ts`, `apps/api/test/tour-publish-audit.spec.ts` | AUD-03 publish audit |
...
| `apps/api/src/registrations/assert-paid-tour-open-gate.ts` | P5-E-N-004 FIN-01 |
| `apps/api/test/tour-created-finance-side-effect.spec.ts` | P5-E-N-005 verify |