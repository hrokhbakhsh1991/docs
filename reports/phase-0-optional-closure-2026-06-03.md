...
- **P0-OPS-03** — GitHub branch protection: **Phase 0 foundation gate** + **Phase 0 integration gate** + **Phase 1 platform-core gate** — [`GITHUB_BRANCH_PROTECTION.md`](GITHUB_BRANCH_PROTECTION.md); `pnpm run ops:branch-protection:main` after `gh auth login`
