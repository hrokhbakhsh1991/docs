...
/**
 * @param {ReturnType<typeof import("./generate-workspace-registry.mjs").discoverManifests>[number]} manifest
 */
...
/** @param {ReturnType<typeof import("./generate-workspace-registry.mjs").discoverManifests>} manifests */
