...
hosts_line="127.0.0.1 operator.localhost denali.localhost urban.localhost wallet-ws1.localhost wallet-ws1.admin.localhost admin.wallet-ws1.localhost wallet-ws1.portal.localhost portal.wallet-ws1.localhost denali.portal.localhost portal.denali.localhost portal.operator.localhost operator.portal.localhost denali.admin.localhost admin.denali.localhost operator.admin.localhost admin.operator.localhost urban.admin.localhost admin.urban.localhost operator.portal.localhost admin.localhost"
