...
STAGING_PUBLIC_IP="${STAGING_PUBLIC_IP:-89.42.210.252}"
VPS_IP="${VPS_IP:-$(hostname -I | awk '{print $1}')}"
PUBLIC_IP="${PUBLIC_IP:-$(curl -fsS --max-time 3 ifconfig.me 2>/dev/null || echo "$STAGING_PUBLIC_IP")}"
FALLBACK_HOSTS="${STAGING_PUBLIC_IP},127.0.0.1,${PUBLIC_IP},${VPS_IP}"
...
MINIO_PUBLIC_ENDPOINT=http://${STAGING_PUBLIC_IP}:9002
...
PUBLIC_TENANT_FALLBACK_HOSTS=${FALLBACK_HOSTS}
...
TOUR_OPS_PUBLIC_FALLBACK_HOSTS=${FALLBACK_HOSTS}
PUBLIC_TENANT_FALLBACK_LABEL=denali
PUBLIC_TENANT_FALLBACK_HOSTS=${FALLBACK_HOSTS}
AUTH_JWT_ISSUER=${AUTH_JWT_ISSUER:-tour-ops}
AUTH_JWT_AUDIENCE=${AUTH_JWT_AUDIENCE:-tour-ops-api}
...
TOUR_OPS_API_URL=http://127.0.0.1:23001
PLATFORM_ROOT_DOMAIN=localhost
MARKETING_PUBLIC_BASE_URL=http://denali.localhost:23002
PORTAL_PUBLIC_BASE_URL=http://portal.denali.localhost:23003
MARKETING_REVALIDATE_SECRET=${REVALIDATE_SECRET}
SESSION_COOKIE_SECURE=false
PUBLIC_TENANT_FALLBACK_LABEL=denali
PUBLIC_TENANT_FALLBACK_HOSTS=${FALLBACK_HOSTS}
...
PLATFORM_ROOT_DOMAIN=localhost
MARKETING_PUBLIC_BASE_URL=http://denali.localhost:23002
PORTAL_INTERNAL_URL=http://127.0.0.1:23003
SESSION_COOKIE_SECURE=false
PUBLIC_TENANT_FALLBACK_LABEL=denali
PUBLIC_TENANT_FALLBACK_HOSTS=${FALLBACK_HOSTS}
TOUR_OPS_PUBLIC_FALLBACK_HOSTS=${FALLBACK_HOSTS}
