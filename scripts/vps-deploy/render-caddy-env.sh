...
PLATFORM_ROOT_DOMAIN=${PLATFORM_ROOT_DOMAIN}
CANONICAL_TENANT_LABEL=${CANONICAL_TENANT_LABEL}
API_PORT=${API_PORT}
WEB_PORT=${WEB_PORT}
...
chmod 640 "$OUT"
echo "[caddy-env] wrote $OUT (root=${PLATFORM_ROOT_DOMAIN} tenant=${CANONICAL_TENANT_LABEL} web=${WEB_PORT} mkt=${MARKETING_PORT} ptl=${PORTAL_PORT})"
