...
const WORKSPACE_FINANCE_HOST_INFRA_ALLOWLIST = new Set([
  "adapter-identity-stability.spec.ts",
  "assert-finance-access.ts",
  "booking-sync-degraded-persist.spec.ts",
  "booking-write-hygiene.spec.ts",
  "compile-invoice-balances.ts",
  "create-commercial-quote-service.ts",
  "enqueue-finance-ledger-capture.spec.ts",
  "enqueue-finance-ledger-capture.ts",
  "enqueue-finance-schedule-audit.ts",
  "finance-capability-certification.spec.ts",
  "finance-capability-gate.spec.ts",
  "finance-chart-of-accounts-registry.ts",
  "finance-commercial-quote-store.ts",
  "finance-composition-isolation.spec.ts",
  ...
  "finance-ws5-onboarding.spec.ts",
  "finance-ws6-onboarding.spec.ts",
  ...
  "apply-free-collection-after-booking-approve.spec.ts",
  "apply-free-collection-after-booking-approve.ts",
  "case",
  "case-read",
  "finance-cancel-pending-payment-http.spec.ts",
  "resolve-finance-workspace-type-for-tenant.ts",
  "tour-created-paid-ledger-exclusive.ts",
  "workspace-finance-bindings.generated.ts",
  "workspace-finance-capabilities.generated.ts",
  "workspace-finance-case-read-bindings.generated.ts",
  ...
  "workspace-finance-obligation-bindings.generated.ts",
