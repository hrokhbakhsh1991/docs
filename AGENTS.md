...
pnpm run test:full                  # canonical phase-5 gate; RLS when DATABASE_URL set
...
pnpm run phase-3:gate               # build/test + phase-2:guard + guard + apps-cert
pnpm run phase-4:gate               # full Phase 4 closure; no historical nested phase chain
