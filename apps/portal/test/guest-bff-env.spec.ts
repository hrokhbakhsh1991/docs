...
describe("portal env — P8-2-N-004", () => {
  it("assertGuestBffProductionConfig fails without JWT in production", async () => {
    const { assertGuestBffProductionConfig } = await import("../src/env");
