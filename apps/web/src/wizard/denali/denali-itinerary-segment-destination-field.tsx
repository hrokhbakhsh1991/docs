...
import {
  readDenaliDestinationLabel,
  useDenaliDestinationCatalog,
} from "./use-denali-destination-catalog";
import { buildItinerarySegmentDestinationSelection } from "./denali-itinerary-segment-destination-logic";
