...
import { useDenaliCanonical, useDenaliCanonicalValue, useDenaliDestinationQuickAdd, useDenaliStepFieldRules } from "@/features/tours/wizard/denali/application";
...
export function DenaliBasicInfoSection() {
  ...
  return (
    <div style={{ display: "grid", gap: "0.85rem" }} data-testid="denali-section-basics">
