export const TOUR_REGISTER_TEST_IDS = {
  page: "operator-tour-register-page",
  form: "operator-tour-register-form",
  guestInput: "operator-tour-register-guest",
  partyInput: "operator-tour-register-party",
