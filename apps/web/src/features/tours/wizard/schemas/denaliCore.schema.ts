/**
 * Denali wizard — Core Identity slice (basic info, program, photos, metrics).
 * Composed full form type and defaults live here for consumers that need the whole RHF shape.
 */
