...
export function DenaliTransportStep() {
  ...
  return (
    <div style={{ display: "grid", gap: "0.85rem" }} data-testid="denali-step-transport">
      ...
      {ui.isVisible("denali_transport", "transport.transportCost", form) ? (
        <FormField
      ...
      {ui.isVisible("denali_transport", "transport.dongAmount", form) ? (
