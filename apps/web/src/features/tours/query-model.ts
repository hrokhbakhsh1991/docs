...
export const TOURS_LIST_TEST_IDS = {
  ...
  tableMobile: "operator-tours-table-mobile",
  row: "operator-tours-row",
  rowMeta: "operator-tours-row-meta",
  rowActions: "operator-tours-row-actions",
  rowSkeleton: "operator-tours-row-skeleton",
  mobileRowSkeleton: "operator-tours-mobile-row-skeleton",
