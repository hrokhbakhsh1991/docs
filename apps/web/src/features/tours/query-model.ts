...
export const TOURS_LIST_TEST_IDS = {
  ...
  listMobile: "operator-tours-list-mobile",
  ...
  tableDesktop: "operator-tours-table-desktop",
  tableTourHeader: "operator-tours-table-tour-header",
  tableStatusHeader: "operator-tours-table-status-header",
  tableScheduleHeader: "operator-tours-table-schedule-header",
  tableCapacityHeader: "operator-tours-table-capacity-header",
  tablePriceHeader: "operator-tours-table-price-header",
  tableUpdatedHeader: "operator-tours-table-updated-header",
  tableActionsHeader: "operator-tours-table-actions-header",
  mobileRow: "operator-tours-mobile-row",
  rowMeta: "operator-tours-row-meta",
  row: (tourId: string) => `operator-tours-row-${tourId}`,
  rowSkeleton: "operator-tours-row-skeleton",
