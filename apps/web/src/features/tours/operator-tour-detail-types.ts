...
export const TOUR_EDIT_TEST_IDS = {
  ...
  saveSecondary: "operator-tour-edit-save-secondary",
  draftManualSave: "operator-tour-edit-draft-manual-save",
  warmError: "operator-tour-edit-warm-error",
  warmRetry: "operator-tour-edit-warm-retry",
  warmBack: "operator-tour-edit-warm-back",
