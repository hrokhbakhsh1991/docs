...
import type { RegistrationFieldPolicy } from "./types";
...
/** Lean intake schema without driver/passenger transport detail fields. */
export function buildRegistrationIntakeCoreSchema(
  policy: RegistrationFieldPolicy,
  messages: RegistrationIntakeSchemaMessages,
) {
  return z
...
export type RegistrationIntakeCoreFormValues = z.infer<
  ReturnType<typeof buildRegistrationIntakeCoreSchema>
>;
