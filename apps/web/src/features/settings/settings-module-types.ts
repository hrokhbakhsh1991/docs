...
export const SETTINGS_HUB_TEST_IDS = {
  ...
  equipmentEdit: "operator-settings-equipment-edit",
  equipmentEditSave: "operator-settings-equipment-edit-save",
  equipmentEditCancel: "operator-settings-equipment-edit-cancel",
  ...
  tourThemesEdit: "operator-settings-tour-themes-edit",
  tourThemesEditSave: "operator-settings-tour-themes-edit-save",
  tourThemesEditCancel: "operator-settings-tour-themes-edit-cancel",
