    ...
    <li ref={setNodeRef} style={style} className={panelStyles.listItem}>
      <div className={panelStyles.listItemInner}>
        <button
          ...
          aria-label={t("equipmentDragHandleLabel")}
          {...attributes}
          {...listeners}
        >
          ⠿
        ...
        <div className={panelStyles.listItemMain}>
          <div>
            ...
            {!item.isActive ? <span className={panelStyles.listItemBadge}>— {t("equipmentInactiveBadge")}</span> : null}
          </div>
          <div className={panelStyles.listItemActions}>
            ...
            >
              <Checkbox
                ...
                aria-label={t("equipmentFieldActive")}
              />
              <span>{t("equipmentFieldActive")}</span>
            </label>
