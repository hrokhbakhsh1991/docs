...
export const USERS_ROUTE_COPY = {
  list: {
    ...
    rewardsModal: {
      ...
      description: "Set permanent discount and reward badges for {name} in this workspace only.",
      ...
      badgesLegend: "Reward badges",
      cancelButton: "Cancel",
      saveButton: "Save rewards",
      savingButton: "Saving…",
      savedToast: "Member rewards updated.",
      saveErrorFallback: "Could not save member rewards."
    },
