...
export const USERS_ROUTE_COPY = {
  list: {
    ...
    selectableLeaderEnabledToast: "Selectable leader enabled for tour forms.",
    selectableLeaderDisabledToast: "Selectable leader disabled for tour forms.",
    selectableLeaderUpdateErrorToast: "Could not update selectable leader.",
    searchLabel: "Search",
    ...
    columnUserProfile: "User profile",
    columnRole: "Role",
    columnFinancialsPrivileges: "Wallet & loyalty",
    neverActiveLabel: "No recent activity",
    columnPermanentDiscount: "Discount %",
    columnRewardBadges: "Reward badges",
    emptyDiscountCell: "—",
    emptyRewardBadgesCell: "—",
    emptyPrivilegesCell: "—",
    phoneVerifiedAria: "Phone verified",
    phoneUnverifiedAria: "Phone not verified",
    manageRewardsButton: "Manage rewards",
    exportCsvAriaLabel: "Export members to CSV",
    inviteUserButton: "Invite user",
    rowActionsMenuAriaLabel: "Actions for {name}",
    menuChangeRole: "Change role",
    menuCurrentRole: "current",
    menuManageRewards: "Manage rewards & selectable leader",
    menuToggleSelectableLeaderOn: "Enable selectable leader (tour forms)",
    menuToggleSelectableLeaderOff: "Disable selectable leader (tour forms)",
    selectableLeaderBadge: "Selectable leader",
    menuRemoveUser: "Remove user",
    menuSuspendUser: "Suspend user",
    menuReactivateUser: "Reactivate user",
    menuResendInvite: "Resend invite",
    telegramLinkedAria: "Telegram account linked",
    emptyLabelsCell: "—",
    columnActions: "Actions",
    rewardsModal: {
      title: "Member rewards & privileges",
      description: "Business privileges for {name} in this workspace (discount, tour leader eligibility, loyalty tier).",
      discountLabel: "Permanent discount (%)",
      discountHint: "Integer from 0 to 100. Leave empty to clear the discount.",
      discountPlaceholder: "e.g. 10",
      discountValidationError: "Discount must be a whole number between 0 and 100.",
      selectableLeaderLabel: "Selectable tour leader",
      selectableLeaderHint: "Allows this member to appear in Denali tour leader pickers regardless of role.",
      loyaltyClubLabel: "Loyalty club tier",
      loyaltyClubNone: "None",
      loyaltyClubHint: "At most one club tier is stored per member.",
      cancelButton: "Cancel",
      saveButton: "Save",
      savingButton: "Saving…",
      savedToast: "Member privileges updated.",
      saveErrorFallback: "Could not save member privileges."
    },
