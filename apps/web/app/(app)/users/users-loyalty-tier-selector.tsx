...
const LOYALTY_RADIO_CLASS =
  "mt-0.5 size-4 shrink-0 cursor-pointer accent-[hsl(var(--primary))] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring disabled:cursor-not-allowed disabled:opacity-50";
