...
const HANDLER_DISPATCH_KIND = {
  ...
  handleFinanceCancelPendingManualPayment: "finance-param",
  ...
  handleFinanceListExceptions: "finance",
  handleFinanceListRefunds: "finance",
  handleFinanceRequestRefund: "finance",
  ...
  handleFinanceOutstandingBalances: "finance",
  handleFinanceTourCollections: "finance",
  ...
  handleFinanceCaseEncounter: "finance-param",
  handleFinanceCaseCommandReviewReceipt: "finance",
  handleGetDenaliCatalog: "product",
  handleGetDenaliCatalogTour: "product-param",
  handleGetDenaliDashboardTour: "product-param",
  handleGetDenaliRegistrationForTour: "product-param",
  handleGetDenaliRegistration: "product-param",
  handleGetDenaliReminderFeed: "product",
  handleGetCertClubCatalog: "product",
  handleGetCertClubCatalogTour: "product-param",
  handleGetCertEventsCatalog: "product",
  handleGetCertEventsCatalogTour: "product-param",
  ...
  handleGetProfileCertCatalog: "product",
  handleGetProfileCertCatalogTour: "product-param",
  handleGetUrbanCatalog: "product",
  handleGetUrbanCatalogTour: "product-param",
  handleGetUrbanSettings: "bare",
  handlePatchDenaliRegistration: "product-param",
  handlePatchUrbanSettings: "bare",
  handlePostDenaliRegistration: "product",
  handlePostCertClubRegistration: "product",
  handlePostCertEventsRegistration: "product",
