...
describe("finance-http-handlers-ownership.spec.ts — Phase 1.4 C2", () => {
  ...
  it("FIN-P1.4-C2-03 finance route path inventory matches finance-http SoT (Denali re-export)", () => {
    ...
    assert.deepEqual(paths, [
      ...
      "GET /finance/reports/tour-collections",
      ...
      "POST /finance/refunds/:refundId/approve",
      "POST /finance/refunds/:refundId/cancel",
      "POST /finance/refunds/:refundId/complete",
      "POST /finance/refunds/:refundId/reject",
