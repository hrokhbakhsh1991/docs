 ...
 * @see docs/phase-18/agent-pack/ANTI-DRIFT.md
 */
...
describe("p5-anti-drift-contract", () => {
  it("AD-C-01 ANTI-DRIFT catalog defines S0 stop patterns", () => {
    const doc = readFileSync(join(repoRoot, "docs/phase-18/agent-pack/ANTI-DRIFT.md"), "utf8");
  ...
  it("AD-C-03 epic B spec forbids rules deletion shortcut", () => {
    const spec = readFileSync(
      join(repoRoot, "docs/phase-18/agent-pack/p5-b-denali-operator-parity.md"),
      "utf8"
    );
