...
|          2 | T01 — قرارداد جستجو، فیلتر و مرتب‌سازی                   | P0     | T00                                     | `SOURCE_FIXED_RETEST_REQUIRED` | همهٔ لیست‌های مدیریت تور به آن وابسته‌اند |
...
|          4 | T03 — یکسان‌سازی summary و فهرست مالی                   | P1     | T00                                     | `IN_PROGRESS`                  | منبع اعداد پرداخت، بدهی و وضعیت settlement باید یکی باشد |
...
|          6 | T02 — یکسان‌سازی ظرفیت و عنوان تور                      | P1     | T01                                     | `SOURCE_FIXED_RETEST_REQUIRED` | ظرفیت/عنوان نادرست مستقیماً روی ثبت‌نام اثر می‌گذارد |
...
- وضعیت T03: `IN_PROGRESS`؛ invariant چهارحالته در source/test پوشش داده شد. هنوز باید در browser ثابت شود بارگذاری صفحهٔ بعد و جمع rollup با فیلتر همان tour درست دیده می‌شود و payload واقعی summary، by-tour، outstanding و rows با همان dataset هم‌خوان است. تا تکمیل این runtime proof، بسته‌شدن T03 ممنوع است.
