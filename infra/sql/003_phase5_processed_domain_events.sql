-- Phase 5.4-S4 — consumer idempotency log (domain_event_id dedupe per tenant)
-- Prerequisite: infra/sql/002_phase5_data_layer.sql
...
CREATE INDEX IF NOT EXISTS idx_processed_domain_events_tenant_processed
...
-- Idempotent guard: outbox unique (tenant_id, domain_event_id) when column present
