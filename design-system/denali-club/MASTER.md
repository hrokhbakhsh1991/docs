...
**Marketing implementation:** `apps/marketing` loads Calistoga via `next/font/google` (`--font-heading-en`); Denali catalog headings use `--font-heading` in `packages/workspaces/denali/theme/denali-marketing.css`.
